...
class PhoneApi
{
    ...
    public function checkPhoneValueGetWithHttpInfo($value)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Service\Module\ValidatorPhoneResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Service\Module\ValidatorPhoneResponse', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Service\Module\ValidatorPhoneResponse',
